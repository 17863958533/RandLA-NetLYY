...
class ConfigS3DIS:
    ...
    batch_size = 1  # batch_size during training  Default:6
    val_batch_size = 20  # batch_size during validation and test
    train_steps = 500  # Number of steps per epochs
    val_steps = 100  # Number of validation steps per epoch
...
#     sub_grid_size = 0.5  # preprocess_parameter   Default:0,060
#
#     batch_size = 1  # batch_size during training   Dfault:4   !!!
#     val_batch_size = 4  # batch_size during validation and test  Dfault:16   !!!
#     train_steps = 500  # Number of steps per epochs  Dfault:500
#     val_steps = 100  # Number of validation steps per epoch  Dfault:100
#
#     sub_sampling_ratio = [4, 4, 4, 4, 2]  # sampling ratio of random sampling at each layer
#     d_out = [16, 64, 128, 256, 512]  # feature dimension
#
#     noise_init = 3.5  # noise initial parameter
#     max_epoch = 100  # maximum epoch during training  Dfault:100   !!!
#     learning_rate = 1e-2  # initial learning rate
#     lr_decays = {i: 0.95 for i in range(0, 500)}  # decay rate of learning rate
#
#     train_sum_dir = 'train_log'
...
# This is my data.   xiugai!!!
class mydata:
    k_n = 16  # KNN
    num_layers = 5  # Number of layers
    num_points = 95536  # Number of input points  Default:65536
    ...
    noise_init = 3.5  # noise initial parameter
    max_epoch = 100  # maximum epoch during training  Dfault:100   !!!
    learning_rate = 0.01  # initial learning rate  Default:1e-2
    lr_decays = {i: 0.95 for i in range(0, 500)}  # decay rate of learning rate
...
class DataProcessing:
    ...
    def get_class_weights(dataset_name):
        ...
        elif dataset_name is 'mydata':
            # num_per_class = np.array([74869515, 1405326, 960522, 21008431, 356024, 11915265, 3123189, 26200021, 173975])   #LYYDaya1  class_num=9   ignore_label[]
            # num_per_class = np.array([1405326, 960522, 21008431, 356024, 11915265, 3123189, 26200021, 173975])    #LYYDaya1  class_num=8   ignore_label[0]
            #num_per_class = np.array([74869515, 1766969, 1207558, 26411964, 447120, 14982766, 3926134, 32938210, 218673])  # LYYDaya2  class_num=9   ignore_label[]
            # num_per_class = np.array([1766969, 1207558, 26411964, 447120, 14982766, 3926134, 32938210, 218673], dtype=np.int32)  # LYYDaya2  class_num=8   ignore_label[0]
            # num_per_class = np.array([17159291, 161208889, 2750511, 95987544, 24477427, 197276360])  # LYYDaya3  class_num=6   ignore_label[]  11 trainData
            num_per_class = np.array([23731087, 219565663, 3739374, 129085493, 33152940, 270054223])  # LYYDaya3  class_num=6   ignore_label[]  12 trainData
