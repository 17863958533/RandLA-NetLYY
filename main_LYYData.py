...
from tester_LYYData import ModelTester
...
#Train: python main_LYYData.py --mode train --gpu 0
#Test: python main_LYYData.py --mode test --gpu 0 --model_path /home/pc/myGitHub/RandLA-Net/results/Log_2023-09-29_05-58-50/snapshots/snap-17001
# python main_LYYData.py --mode test --gpu 0 --model_path /home/pc/myGitHub/RandLA-Net/results/Log_2023-10-01_12-40-52/snapshots/snap-11001


class mydata:
    def __init__(self):
        self.name = 'mydata'
        self.path = '/media/pc/C8BE4D94BE4D7BC6/data/LYYData3/'
        # self.label_to_names = {0: 'Unlabeled',
        #                        1: 'MiddleCompositeSupport',
        #                        2: 'MiddleSteelStructure',
        #                        3: 'Land',
        #                        4: 'TowerCrane',
        #                        5: 'SupportFrame',
        #                        6: 'ConstructionVehicles',
        #                        7: 'Dome',
        #                        8: 'DomeBottomBracket'
        #                        }
        ...
        self.ignored_labels = np.sort([])   #这一行是为了将标签为0的点不参与训练，同时需要修改——tf_tool.py下面的权值矩阵的维度，改称8个，如果这个地方置空，则权值矩阵维度为9！！！
        ...
        #train_Path0 = '0UnlabeledNew'
        # train_Path1 = '1MiddleCompositeSupportNew'
        # train_Path2 = '2MiddleSteelStructureNew'
        # train_Path3 = '3LandNew'
        # train_Path4 = '4TowerCraneNew'
        # train_Path5 = '5SupportFrameNew'
        # train_Path6 = '6ConstructionVehiclesNew'
        # train_Path7 = '7DomeNew'
        # train_Path8 = '8DomeBottomBracketNew'

        # val_Path1 = 'val_data1New'
        # val_Path2 = 'val_data2New'
        # val_Path3 = 'val_data3New'

        val_Path1 = 'valData1'
        val_Path2 = 'valData2'
        val_Path3 = 'valData3'

        test_Path1 = 'testData1_noLable'
        test_Path2 = 'testData2_noLable'
        test_Path3 = 'testData3_noLable'

        self.val_split = [val_Path1, val_Path2, val_Path3]  # "file1"是点云文件的名字，bu neng dai hou zhui!!!
        self.test_split = [test_Path1, test_Path2, test_Path3]
        ...
        for pc_name in cloud_names:
            ...
            #if pc_name in self.test_split:
                self.test_files.append(pc_file)
            else:
            #if pc_name in self.train_split:
        ...
        self.ascii_files = {'testData1_noLable.ply': 'testData1.labels',
            'testData2_noLable.ply': 'testData2.labels',
            'testData3_noLable.ply': 'testData3.labels'}
